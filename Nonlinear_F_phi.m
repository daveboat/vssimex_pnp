function NF = Nonlinear_F_phi(bc, dx,N1,N2,N3, lambda_s, epsilon_1,epsilon_2,epsilon_3,epsilon_s_left,epsilon_s_right,cp,cm,z_cp,z_cm,phi, phi_x_right,v)
% 1d poisson solver
%
...
%
% This subroutine returns NF = RHS-LHS = -1/2 sum_i(c_i) - epsilon^2 d^2 phi/dx^2
...
for i=2:N1-1
    ...
    % to solve Poisson w/ no source terms
    % b(i)=0;
end
%
...
% phi = A \ b;
%
% remove phi effects from code and reduce to heat equation:
% phi = ones(size(b));
