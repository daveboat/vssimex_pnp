% minimal version of running fully implicit code, with fsolve, for 
% profiling purposes this is the code which runs for figure 4 of the pnp 
% paper (by changing the value of epsilon)
