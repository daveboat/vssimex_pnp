...
[phi_coarse,cp_coarse,cm_coarse,phi_x_right_coarse,NF_coarse] = Newton_one_step(t_now,dt,phi_x_right_now,cp_now,cm_now,phi_now,bc, dx,N1,N2,N3, lambda_s,D_0,D_p,D_m,kc_left,jr_left,kc_right,jr_right,epsilon_1,epsilon_2,epsilon_3,epsilon_s_left,epsilon_s_right,z_cp,z_cm);
%fine step ONE-STEP NEWTON!
[phi_half,cp_half,cm_half,phi_x_right_half,NF_half] = Newton_one_step(t_now,dt/2,phi_x_right_now,cp_now,cm_now,phi_now,bc, dx,N1,N2,N3, lambda_s,D_0,D_p,D_m,kc_left,jr_left,kc_right,jr_right,epsilon_1,epsilon_2,epsilon_3,epsilon_s_left,epsilon_s_right,z_cp,z_cm);
[phi_fine,cp_fine,cm_fine,phi_x_right_fine,NF_fine] = Newton(t_now+dt/2,dt/2,dt/2,phi_half,phi_now,phi_x_right_half,phi_x_right_now,cp_half,cp_now,cm_half,cm_now,bc, dx,N1,N2,N3, lambda_s,D_0,D_p,D_m,kc_left,jr_left,kc_right,jr_right,epsilon_1,epsilon_2,epsilon_3,epsilon_s_left,epsilon_s_right,z_cp,z_cm);
it=it+1;
%evaluate error
...
while t_now<t_end - eps
    ...
    [phi_coarse,cp_coarse,cm_coarse,phi_x_right_coarse,NF_coarse] = Newton(t_now,dt,dt_old,phi_now,phi_old,phi_x_right_now,phi_x_right_old,cp_now,cp_old,cm_now,cm_old,bc, dx,N1,N2,N3, lambda_s,D_0,D_p,D_m,kc_left,jr_left,kc_right,jr_right,epsilon_1,epsilon_2,epsilon_3,epsilon_s_left,epsilon_s_right,z_cp,z_cm);
    %fine step (with dt/2 where dt is same as previous step)
    [phi_half,cp_half,cm_half,phi_x_right_half,NF_half] = Newton(t_now,dt/2,dt_old/2,phi_now,phi_half_old,phi_x_right_now,phi_x_right_half_old,cp_now,cp_half_old,cm_now,cm_half_old,bc, dx,N1,N2,N3, lambda_s,D_0,D_p,D_m,kc_left,jr_left,kc_right,jr_right,epsilon_1,epsilon_2,epsilon_3,epsilon_s_left,epsilon_s_right,z_cp,z_cm);
    % second fine step
    [phi_fine,cp_fine,cm_fine,phi_x_right_fine,NF_fine] = Newton(t_now+dt/2,dt/2,dt/2,phi_half,phi_now,phi_x_right_half,phi_x_right_now,cp_half,cp_now,cm_half,cm_now,bc, dx,N1,N2,N3, lambda_s,D_0,D_p,D_m,kc_left,jr_left,kc_right,jr_right,epsilon_1,epsilon_2,epsilon_3,epsilon_s_left,epsilon_s_right,z_cp,z_cm);
    it=it+1;
