% this code runs but doesn't save except for the final step
%[ cp_new,cm_new,phi_x_right_new,debug1 ] = step(bc,t,dt_now,dt_old,dx,N1,N2,N3,cp_now,cm_now,phi_now,phi_x_right_now,cp_old,cm_old,phi_old,phi_x_right_old,lambda_s,D_0,D_p,D_m,kc_left,jr_left,kc_right,jr_right,epsilon_1,epsilon_2,epsilon_3,epsilon_s_left,epsilon_s_right,z_cp,z_cm,k,a_left,a_1,a_2,a_3,a_right,h_left,h_right,gamma_left,gamma_right)
%
debug1=zeros(N,1);
